...
var Chicken = function (_FoodItem) {
	_inherits(Chicken, _FoodItem);

	function Chicken(food) {
		_classCallCheck(this, Chicken);

		var _this = _possibleConstructorReturn(this, (Chicken.__proto__ || Object.getPrototypeOf(Chicken)).call(this));
